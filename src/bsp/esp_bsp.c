...
esp_err_t bsp_touch_new(const bsp_display_cfg_t *config, esp_lcd_touch_handle_t *ret_touch)
{
    ...
    // Use v1 (legacy) API directly to avoid i2c_master_bus_handle_t conflict
    ESP_RETURN_ON_ERROR(esp_lcd_new_panel_io_i2c_v1((uint32_t)BSP_I2C_NUM, &tp_io_config, &tp_io_handle), TAG, "");
